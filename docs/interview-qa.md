...
- **[一、项目整体认知](#一项目整体认知)**
  ...
  - [Q4：这个项目真正解决的用户问题 / 难点是什么？](#q4这个项目真正解决的用户问题--难点是什么)
  - [Q5：什么是 OCR？它和 ASR 有什么区别？](#q5什么是-ocr它和-asr-有什么区别)
  - [Q6：ASR、OCR、Embedding 和 LLM 分别怎么选？](#q6asrocrembedding-和-llm-分别怎么选)
  - [Q7：主要数据分别存在哪里？为什么这样分？](#q7主要数据分别存在哪里为什么这样分)
  - [Q8：大量代码由 AI 辅助生成，你自己的价值在哪里？](#q8大量代码由-ai-辅助生成你自己的价值在哪里)
...
- **[五、分片上传与断点续传](#五分片上传与断点续传)**
  ...
  - [Q49：为什么分片限制在 5MB、总分片限制为 410？](#q49为什么分片限制在-5mb总分片限制为-410)
